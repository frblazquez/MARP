...
equivalente (manteniendo exactamente los elementos iniciales) pero en el que 
la raiz es el nodo seleccionado. Surge entonces la duda siguiente, ¿cómo 
conseguir llevar el nodo seleccionado hasta la raiz sin quebrar la estructura
de árbol binario de búsqueda? Esto se consigue realizando una serie de 
rotaciones.
